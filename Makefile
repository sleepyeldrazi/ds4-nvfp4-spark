...
# the backend.
CORE_OBJS = ds4.o ds4_util.o ds4_gguf.o ds4_quant.o ds4_tokenizer.o ds4_cuda.o
CPU_CORE_OBJS = ds4_cpu.o ds4_util_cpu.o ds4_gguf_cpu.o ds4_quant_cpu.o ds4_tokenizer_cpu.o
